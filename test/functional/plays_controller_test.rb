...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { artist: @play.artist, search_blob: @play.search_blob, song_title: @play.song_title, start_time: @play.start_time }
    end
  ...
  test "should update play" do
    put :update, id: @play, play: { artist: @play.artist, search_blob: @play.search_blob, song_title: @play.song_title, start_time: @play.start_time }
    assert_redirected_to play_path(assigns(:play))
  end
